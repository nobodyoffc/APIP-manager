 ...
 * 传输要签名的32byte长哈希
 * - 私钥 32 字节，
 * - 作为 ByteArray 的“rand”随机数“k”。
 * 返回一个由 2 个元素组成的 BigInteger 数组：[0] = r 和 [1] = s。
 * 注意：“rand”随机数“k”必须来自加密强熵！
 * 如果“k”是可预测的，那么 Priv.Key 很容易被泄露！！！ */
...
/** 检查签名“r”和“s”。
 * - 传输要检查签名的 32 字节散列
 * - 签名本身“sig”为由 2 个元素组成的 BigInteger 数组：[0] = r 和 [1] = s。
 * - Pub.Key 是一个包含 2 个元素的 BigInteger 数组。*/
